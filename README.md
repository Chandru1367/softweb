...
<head>
    <meta charset="UTF-8" />
    <title>Chandru Restaurant - Home</title>
...
<body>
    ...
    <section class="hero">
        <div>
            <h1>Welcome to Chandru Restaurant</h1>
            <h4>Fresh, flavorful meals served daily in a cozy, welcoming atmosphere.</h4>
        </div>
    </section>
    <div class="container">
        <h2>About Us</h2>
        <p class="lead">At Chandru Restaurant, we believe in the power of good food to bring people together. Our chefs use locally sourced ingredients to create dishes packed with flavor. Whether you're craving classic comfort food or something with a modern twist, you'll find it here.</p>
        </div>
    </div>
</body>
</html>
...
<body>
    ...
    <div class="container">
        ...
        <div class="menu-grid">
            ...
            <div class="menu-item">
                <img src="chicken burger.jpg" alt="Grilled Chicken Burger" />
                <div class="menu-content">
            ...
            <div class="menu-item">
                <img src="pasta.avif" alt="Pasta Alfredo" />
                <div class="menu-content">
                    <h3>Pasta Alfredo</h3>
                    <p>₹220</p>
                </div>
            ...
            <div class="menu-item">
                <img src="burger.avif" alt="Veggie Burger" />
                <div class="menu-content">
                    <h3>Veggie Burger</h3>
                    <p>₹150</p>
                </div>
            ...
            <div class="menu-item">
                <img src="salad.avif" alt="Classic Caesar Salad" />
                <div class="menu-content">
...
<body>
    ...
    <div class="container">
        ...
        <div class="contact-details">
            <p><strong>Email:</strong> chandru1367@gmail.com</p>
